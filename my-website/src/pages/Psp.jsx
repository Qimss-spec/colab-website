...
const GAMES = [
  { id: "PSP-301", title: "Nova Sprint", genre: "Racing", status: "Available", year: 2008 },
  { id: "PSP-302", title: "Blade Runner X", genre: "Action", status: "Available", year: 2009 },
  { id: "PSP-303", title: "Rune Valley", genre: "RPG", status: "Coming Soon", year: 2011 },
];
  ...
  return (
    <div className="space-y-6">
      <header className="rounded-3xl border border-zinc-800 bg-zinc-900/50 p-7">
        ...
        <p className="mt-2 text-zinc-300">Browse PSP games (demo data).</p>
